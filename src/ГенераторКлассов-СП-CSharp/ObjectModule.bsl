...
Процедура ОбработатьМетоды(ТипИсточник)
	...
	Пока Выборка.Следующий() Цикл
		...
		для каждого ПараметрМетода из Выборка.Параметры цикл
			...
			СтрМетоды  = СтрМетоды + "/// <param name=""" + СокрЛП(ПараметрМетода.Параметр.Наименование) + """>" + РазметитьОписание(ПараметрМетода.Параметр.Описание) + " Типы: " + СтрТипыПараметра + " </param>";
...
Процедура ОбработатьТипДанных() Экспорт 
	...
	ОбработатьОсновныеПараметры(ТипДанных);
	ОбработатьСвойства(ТипДанных);
	ОбработатьМетоды(ТипДанных);
